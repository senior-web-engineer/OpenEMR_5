...
var page = {
    ...
    init: function () {
        ...
        this.modelView.on('rendered', function () { // model rendered
            ...
            examinerIdValues.fetch({
                success: function (c) {
                    ...
                    c.forEach(function (item, index) {
                        ...
                        if (item.get('encounterType') != localStorage.getItem('EncounterTypeId')) return;
                        var uid = item.get('id')
            ...
            $(function () {
                $('.schedule-date-time-picker').datetimepicker({
                    i18n: {
                        en: {
                            months: datetimepicker_xlMonths,
                            dayOfWeekShort: datetimepicker_xlDayofwkshort,
    ...
    updateModel: function (live) {
        ...
        page.patient.save({
            ...
            'emergencyContact': $('input#emergencyContact').val(),
            'date': $('input#date').val(),
            'sex': $('select#sex').val(),
            ...
            'childName': $('input#childName').val(),
            'childAge': $('input#childAge').val(),
            'presentingProblem': $('textarea#presentingProblem').val(),
            'howCanWeHelpYou': $('textarea#howCanWeHelpYou').val(),
        }, {
            wait: true,
            success: function () {
                debugger;
