...
class PatientMap implements IDaoMap, IDaoMap2
{
    ...
    public static function GetFieldMaps()
    {
        if (self::$FM == null) {
            ...
            self::$FM["EmergencyContact"] = new FieldMap("EmergencyContact", "patient_data", "emergency_contact", false, FM_TYPE_VARCHAR, 255, null, false);
            self::$FM["ScheduleDate"] = new FieldMap("ScheduleDate", "patient_data", "date", false, FM_TYPE_DATETIME, null, null, false);
            ...
            self::$FM["ChildName"] = new FieldMap("ChildName", "patient_data", "child_name", false, FM_TYPE_VARCHAR, 191, null, false);
            self::$FM["ChildAge"] = new FieldMap("ChildAge", "patient_data", "child_age", false, FM_TYPE_INT, null, 2, false);
            self::$FM["PresentingProblem"] = new FieldMap("PresentingProblem", "patient_data", "presenting_problems", false, FM_TYPE_TEXT, null, null, false);
            self::$FM["HowCanWeHelpYou"] = new FieldMap("HowCanWeHelpYou", "patient_data", "how_can_we_help_you", false, FM_TYPE_TEXT, null, null, false);
            self::$FM["AgreeTermsOfUse"] = new FieldMap("AgreeTermsOfUse", "patient_data", "agree_terms_of_use", false, FM_TYPE_TEXT, null, null, false);
        }
