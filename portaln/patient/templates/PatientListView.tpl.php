...
<div class="container-fluid">
    ...
    <script type="text/template" id="patientModelTemplate"> <!-- -->
        ...
        <form class="" onsubmit="return false;" id="patientForm">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group" id="serviceTypeInputContainer">
                            <label for="encounterTypeId"><?php echo xlt('Select Service Type') ?></label>
                            <div class="controls inline-inputs">
                                <?php
                                # Generate drop down list for service type
                                echo generate_select_list('service_type', 'service_type', $row['service_type'], xl('Service Type'), 'Unassigned', "form-control");
                                ?>
                                <span class="help-inline"></span>
                            </div>
                        </div>
...
<!--                                --><?php //echo xlt('Select Primary Physician') ?><!--</label>-->
<!--                            <div class="controls inline-inputs">-->
<!--                                <select class="form-control" id="providerid"-->
<!--                                        value="<%= _.escape(item.get('providerid') || '') %>"></select>-->
<!--                                <span class="help-inline"></span>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="childAgeInputContainer">
                            <label for="scheduleDate"><?php echo xlt('Schedule Date') ?></label>
                            <div class="controls inline-inputs">
                                <div>
                                    <input id="scheduleDate" type="text" class="form-control schedule-date-time-picker"
                                           placeholder="<?php echo xla('Schedule Date'); ?>"
                                           value="<%= item.get('scheduleDate') %>"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="fnameInputContainer">
                            <label for="fname"><?php echo xlt('First') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="fname" required
                                       placeholder="<?php echo xla('First Name'); ?>"
                                       value="<%= _.escape(item.get('fname') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="mnameInputContainer">
                            <label for="mname"><?php echo xlt('Middle') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="mname"
                                       placeholder="<?php echo xla('Middle Name'); ?>"
                                       value="<%= _.escape(item.get('mname') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="lnameInputContainer">
                            <label for="lname"><?php echo xlt('Last') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="lname" required
                                       placeholder="<?php echo xla('Last Name'); ?>"
                                       value="<%= _.escape(item.get('lname') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="childNameInputContainer">
                            <label for="childName"><?php echo xlt('Child Name') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="childName"
                                       value="<%= _.escape(item.get('childName') || '') %>">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="childAgeInputContainer">
                            <label for="childAge"><?php echo xlt('Child Age') ?></label>
                            <div class="controls inline-inputs">
                                <div>
                                    <input id="childAge" type="number" required class="form-control"
                                           placeholder="<?php echo xla('Child Age'); ?>"
                                           value="<%= item.get('childAge') %>"/>
                                </div>
                            </div>
                        </div>
                    </div> -->
                ...
                <div class="row"><!--Start of row 3-->
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="dobInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <div>
                                    <input id="dob" type="text" required class="form-control jquery-date-picker"
                                           placeholder="<?php echo xla('I know but we need it!'); ?>"
                                           value="<%= item.get('dob') %>"/>
                                </div>
                                <span class="help-inline"></span>
                            </div>
                    ...
                    <div class="form-group inline  dynhide hide" id="pidInputContainer">
                        ...
                        <div class="controls inline-inputs">
                            <input type="text" class="form-control" id="pid" placeholder="<?php echo xla('Pid') ?>"
                                   value="<%= _.escape(item.get('pid') || '') %>">
                            <span class="help-inline"></span>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="pubpidInputContainer">
                            <label for="pid"><?php echo xlt('Public Patient Id') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="pubpid" disabled
                                       value="<%= _.escape(item.get('pubpid') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="ssInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="ss" title="###-##-####"
                                       placeholder="<?php echo xla('Social Security(Optional)'); ?>"
                                       value="<%= _.escape(item.get('ss') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" id="streetInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="street" required
                                       placeholder="<?php echo xla('Street'); ?>"
                                       value="<%= _.escape(item.get('street') || '') %>"/>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" id="cityInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="city" required
                                       placeholder="<?php echo xla('City'); ?>"
                                       value="<%= _.escape(item.get('city') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group" id="postalCodeInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="postalCode"
                                       placeholder="<?php echo xla('Postal Code'); ?>"
                                       value="<%= _.escape(item.get('postalCode') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" id="countyInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="county"
                                       placeholder="<?php echo xla('County'); ?>"
                                       value="<%= _.escape(item.get('county') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php //echo xlt('Country Code') ?><!--</label>-->
                    <!--                            <div class="controls inline-inputs">-->
                    <!--                                <input type="text" class="form-control" id="countryCode"-->
                    <!--                                       placeholder="-->
                    <?php //echo xla('Country Code'); ?><!--"-->
                    <!--                                       value="<%= _.escape(item.get('countryCode') || '') %>">-->
                    <!--                                <span class="help-inline"></span>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </div>-->
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="phoneHomeInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="phoneHome" required="required"
                                       placeholder="<?php echo xla('Phone Home'); ?>"
                                       value="<%= _.escape(item.get('phoneHome') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="phoneBizInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="phoneBiz"
                                       placeholder="<?php echo xla('Phone Biz'); ?>"
                                       value="<%= _.escape(item.get('phoneBiz') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="emergencyContactInputContainer">
                            <label for="phoneBiz"><?php echo xlt('Emergency Contact') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="emergencyContact"
                                       placeholder="<?php echo xla('Emergency Contact'); ?>"
                                       value="<%= _.escape(item.get('emergencyContact') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="phoneCellInputContainer">
                            <label for="phoneCell"><?php echo xlt('Emergency Phone') ?></label>
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="phoneCell"
                                       placeholder="<?php echo xla('Phone Emergency'); ?>"
                                       value="<%= _.escape(item.get('phoneCell') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" id="phoneContactInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="phoneContact"
                                       placeholder="<?php echo xla('Phone Contact'); ?>"
                                       value="<%= _.escape(item.get('phoneContact') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="contactRelationshipInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="contactRelationship"
                                       placeholder="<?php echo xla('Contact Relationship'); ?>"
                                       value="<%= _.escape(item.get('contactRelationship') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="dateInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <div class="">
                                    <input disabled id="date" type="text" class="form-control jquery-date-time-picker"
                                           value="<%= item.get('date') %>"/>
                                </div>
                                <span class="help-inline"></span>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group dynhide" id="refProvideridInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <select disabled class="form-control" id="refProviderid"
                                        value="<%= _.escape(item.get('refProviderid') || '') %>"></select>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" id="emailInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="email" class="form-control" id="email" required
                                       placeholder="<?php echo xla('Email'); ?>"
                                       value="<%= _.escape(item.get('email') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group dynhide" id="emailDirectInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="emailDirect"
                                       placeholder="<?php echo xla('Direct Email'); ?>"
                                       value="<%= _.escape(item.get('emailDirect') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="languageInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                ...
                                <!--                                       placeholder="-->
                                <?php //echo xla('Language'); ?><!--"-->
                                <!--                                       value="<%= _.escape(item.get('language') || '') %>">-->
                                <?php
                                # Generate drop down list for Preferred language
                                echo generate_select_list('language', 'language', $row['language'], xl('Preferred Language'), 'Unassigned', "form-control");
                                ?>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group dynhide" id="familySizeInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="familySize"
                                       placeholder="<?php echo xla('Family Size'); ?>"
                                       value="<%= _.escape(item.get('familySize') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group dynhide" id="regdateInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <div>
                                    <input disabled id="regdate" type="text" class="form-control jquery-date-picker"
                                           value="<%= item.get('regdate') %>"/>
                                </div>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="mothersnameInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="mothersname"
                                       placeholder="<?php echo xla('Mothers Name'); ?>"
                                       value="<%= _.escape(item.get('mothersname') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group dynhide" id="guardiansnameInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <input type="text" class="form-control" id="guardiansname"
                                       placeholder="<?php echo xla('Guardians Name'); ?>"
                                       value="<%= _.escape(item.get('guardiansname') || '') %>">
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="hipaaMailInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaMail0"
                                                                                          name="hipaaMail" type="radio"
                                                                                          value="NO"<% if
                                    (item.get('hipaaMail')=="NO") { %> checked="checked"<% } %>><?php echo xlt('NO'); ?>
                                </label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaMail1"
                                                                                          name="hipaaMail" type="radio"
                                                                                          value="YES"<% if
                                    (item.get('hipaaMail')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaMail2"
                                                                                          name="hipaaMail" type="radio"
                                                                                          value=""<% if
                                    (item.get('hipaaMail')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="hipaaVoiceInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaVoice0"
                                                                                          name="hipaaVoice" type="radio"
                                                                                          value="NO"<% if
                                    (item.get('hipaaVoice')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaVoice1"
                                                                                          name="hipaaVoice" type="radio"
                                                                                          value="YES"<% if
                                    (item.get('hipaaVoice')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaVoice2"
                                                                                          name="hipaaVoice" type="radio"
                                                                                          value=""<% if
                                    (item.get('hipaaVoice')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="hipaaNoticeInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaNotice0"
                                                                                          name="hipaaNotice"
                                                                                          type="radio" value="NO"<% if
                                    (item.get('hipaaNotice')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaNotice1"
                                                                                          name="hipaaNotice"
                                                                                          type="radio" value="YES"<% if
                                    (item.get('hipaaNotice')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaNotice2"
                                                                                          name="hipaaNotice"
                                                                                          type="radio" value=""<% if
                                    (item.get('hipaaNotice')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <!--                            <label for="hipaaMessage">-->
                    <?php //echo xlt('Hipaa Message') ?><!--</label>-->
                    <!--                            <div class="controls inline-inputs">-->
                    <!--                                <input type="text" class="form-control" id="hipaaMessage"-->
                    <!--                                       placeholder="-->
                    <?php //echo xla('Hipaa Message'); ?><!--"-->
                    <!--                                       value="<%= _.escape(item.get('hipaaMessage') || '') %>">-->
                    <!--                                <span class="help-inline"></span>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </div>-->
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="hipaaAllowsmsInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm">
                                    <input id="hipaaAllowsms0" name="hipaaAllowsms" type="radio" value="NO"<% if
                                    (item.get('hipaaAllowsms')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm">
                                    <input id="hipaaAllowsms1" name="hipaaAllowsms" type="radio" value="YES"<% if
                                    (item.get('hipaaAllowsms')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm">
                                    <input id="hipaaAllowsms2" name="hipaaAllowsms" type="radio" value=""<% if
                                    (item.get('hipaaAllowsms')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="hipaaAllowemailInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaAllowemail0"
                                                                                          name="hipaaAllowemail"
                                                                                          type="radio" value="NO"<% if
                                    (item.get('hipaaAllowemail')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaAllowemail1"
                                                                                          name="hipaaAllowemail"
                                                                                          type="radio" value="YES"<% if
                                    (item.get('hipaaAllowemail')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="hipaaAllowemail2"
                                                                                          name="hipaaAllowemail"
                                                                                          type="radio" value=""<% if
                                    (item.get('hipaaAllowemail')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="allowImmRegUseInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowImmRegUse0"
                                                                                          name="allowImmRegUse"
                                                                                          type="radio" value="NO"<% if
                                    (item.get('allowImmRegUse')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowImmRegUse1"
                                                                                          name="allowImmRegUse"
                                                                                          type="radio" value="YES"<% if
                                    (item.get('allowImmRegUse')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowImmRegUse2"
                                                                                          name="allowImmRegUse"
                                                                                          type="radio" value=""<% if
                                    (item.get('allowImmRegUse')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="allowImmInfoShareInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowImmInfoShare0"
                                                                                          name="allowImmInfoShare"
                                                                                          type="radio" value="NO"<% if
                                    (item.get('allowImmInfoShare')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowImmInfoShare1"
                                                                                          name="allowImmInfoShare"
                                                                                          type="radio" value="YES"<% if
                                    (item.get('allowImmInfoShare')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowImmInfoShare2"
                                                                                          name="allowImmInfoShare"
                                                                                          type="radio" value=""<% if
                                    (item.get('allowImmInfoShare')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="allowHealthInfoExInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowHealthInfoEx0"
                                                                                          name="allowHealthInfoEx"
                                                                                          type="radio" value="NO"<% if
                                    (item.get('allowHealthInfoEx')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowHealthInfoEx1"
                                                                                          name="allowHealthInfoEx"
                                                                                          type="radio" value="YES"<% if
                                    (item.get('allowHealthInfoEx')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input id="allowHealthInfoEx2"
                                                                                          name="allowHealthInfoEx"
                                                                                          type="radio" value=""<% if
                                    (item.get('allowHealthInfoEx')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group" id="allowPatientPortalInputContainer">
                            ...
                            <div class="controls inline-inputs">
                                <label class="btn btn-default btn-gradient btn-sm"><input disabled
                                                                                          id="allowPatientPortal0"
                                                                                          name="allowPatientPortal"
                                                                                          type="radio" value="NO"<% if
                                    (item.get('allowPatientPortal')=="NO") { %> checked="checked"<% }
                                    %>><?php echo xlt('NO'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input disabled
                                                                                          id="allowPatientPortal1"
                                                                                          name="allowPatientPortal"
                                                                                          type="radio" value="YES"<% if
                                    (item.get('allowPatientPortal')=="YES") { %> checked="checked"<% }
                                    %>><?php echo xlt('YES'); ?></label>
                                <label class="btn btn-default btn-gradient btn-sm"><input disabled
                                                                                          id="allowPatientPortal2"
                                                                                          name="allowPatientPortal"
                                                                                          type="radio" value=""<% if
                                    (item.get('allowPatientPortal')=="") { %> checked="checked"<% }
                                    %>><?php echo xlt('Unassigned'); ?></label>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    ...
                    <!--                            <label for="careTeam">-->
                    <?php //echo xlt('Care Team') ?><!--</label>-->
                    <!--                            <div class="controls inline-inputs">-->
                    <!--                                <select class="form-control" id="careTeam" placeholder="-->
                    <?php //echo xla('Care Team'); ?><!--"-->
                    <!--                                        value="<%= _.escape(item.get('careTeam') || '') %>"></select>-->
                    <!--                                <span class="help-inline"></span>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                    </div>-->
                ...
                <!--                            <label style="color:#e65a7d" for="note">-->
                <?php //echo xlt('Message to Reviewer') ?><!--</label>-->
                <!--                            <div class="controls inline-inputs">-->
                <!--                                <textarea class="form-control" id="note" rows="3" style='min-width:180px'><%= _.escape("To Admin: ") %></textarea>-->
                <!--                                <span class="help-inline"></span>-->
                <!--                            </div>-->
                <!--                        </div>-->
                <!--                    </div>-->
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group inline" id="presentingProblemInputContainer">
                            <label class="control-label"
                                   for="presentingProblem"><?php echo xlt('Presenting Problem(s)') ?></label>
                            <div class="controls inline-inputs">
                                <textarea class="form-control" rows="5" id="presentingProblem"
                                          placeholder="<?php echo xla('Presenting Problem(s)'); ?>"><%= _.escape(item.get('presentingProblem') || '') %></textarea>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group inline" id="howCanWeHelpYouInputContainer">
                            <label class="control-label"
                                   for="howCanWeHelpYou"><?php echo xlt('How can we help you?') ?></label>
                            <div class="controls inline-inputs">
                                <textarea class="form-control" rows="5" id="howCanWeHelpYou"
                                          placeholder="<?php echo xla('How can we help you?'); ?>"><%= _.escape(item.get('howCanWeHelpYou') || '') %></textarea>
                                <span class="help-inline"></span>
                            </div>
                        </div>
                    </div>
