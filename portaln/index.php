...
<html>
<head>
    <title><?php echo xlt('My Portal Login'); ?></title>
    <?php
...
?>  <!-- Main logon -->
    ...
    <img style="width:65%" src='<?php echo $GLOBALS['images_static_relative']; ?>/pirc-logo.png'/>
        <form  class="" action="get_patient_info.php" method="POST" onsubmit="return process()">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <fieldset>
                        <legend class="bg-primary login-heading"><h3><?php echo xlt('My Portal Login'); ?></h3></legend>
                        <div class="login">
                            <div class="col-sm-12">
                                <div class="form-group inline mgbtm">
                            ...
                            <div class="col-sm-12 form-group mgbtm">
                            ...
                            <?php if ($GLOBALS['language_menu_login']) { ?>
                                <?php if (count($result3) != 1) { ?>
                                    <div class="form-group col-sm-12 mgbtm">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <?php if ($GLOBALS['portal_onsite_two_register']) { ?>
                                <button class="btn btn-cstm-default pull-left hide"  style="display:none" onclick="location.replace('./account/register.php')"><?php echo xlt('Register');?></button>
                            <?php } ?>
                            ...
                            <?php } ?>
                            <button  class="btn btn-ctm-success pull-right mgbtm" type="submit" ><?php echo xlt('Log In');?></button>
                        </div>
                    </fieldset>
                </div>
            </div>
