...
<style>
    ...
    ..btn-cstm-grey:hover {
        background-color: #1aa24c !important;
        border-color: #0f8d3d !important;
...
<div id="patient_reports"> <!-- large outer DIV -->
            ...
            <form name='ccr_form' id='ccr_form' method='post' action="../ccr/createCCR.php?portal_auth_two=1">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <h4 class='title'><?php echo xlt('Continuity of Care Record (CCR)'); ?></h4>
                        ...
                        <input type="checkbox" class="mb-3" name="show_date" id="show_date" onchange="show_date_fun();"><span
                                class='text'><?php echo xlt('Use Date Range'); ?></span>
                        <br>
    ...
    <?php //echo xla('Generate Report'); ?></button> -->
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <input type="button" class="btn btn-cstm-grey generateCCR"
                                       value="<?php echo xla('Generate Report'); ?>"/>
                            </div>
                            <div class="col-sm-12 col-md-5">
                                <!-- <input type="button" class="generateCCR_download_h" value="<?php echo xl('Download') . " (Hybrid)"; ?>" /> -->
                                <input type="button" class="btn btn-cstm-grey generateCCR_download_p"
                                       value="<?php echo xlt('Download'); ?>"/>
                            </div>
                        </div>
                                ...
                                <table class="table" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="button" class="viewCCR_transmit"
                                                   value="<?php echo xlt('Send'); ?>"/>
                    ...
                    <!-- <hr/> -->
                    <div class="col-sm-12 col-md-6">
                        <h4 class='title'><?php echo xlt('Continuity of Care Document (CCD)'); ?></h4>
                        <span class='text'>(<?php echo xlt('Pop ups need to be enabled to see these reports'); ?>)</span>
                        <br/>
                        <br/>
                        <br/>
                        <div class="row">
                            <div class="col-sm-12 col-md-5">
                                <input type="button" class="viewCCD btn btn-cstm-grey"
                                       value="<?php echo xla('Generate Report'); ?>"/>
                            </div>
                            <div class="col-sm-12 col-md-5">
                                <input type="button" class="viewCCD_download btn btn-cstm-grey"
                                       value="<?php echo xlt('Download'); ?>"/>
                            </div>
                        </div>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <input type="button" class="viewCCD_transmit"
                                                   value="<?php echo xlt('Send'); ?>"/>
    ...
    <form name='report_form' id="report_form" method='post' action='./report/portal_custom_report.php'>
        ...
        <table class="table includes">
            <tr>
                <td class='text'>
                    <input type='checkbox' name='include_demographics' id='include_demographics' value="demographics"
                           checked><?php echo xlt('Demographics'); ?><br>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <input type="button" class="genreport btn btn-cstm-grey" value="<?php echo xlt('Generalate Report'); ?>"/>
        </div>
        <div class="col-sm-12 col-md-4">
            <input type="button" class="genpdfrep btn btn-cstm-grey" value="<?php echo xlt('Download PDF'); ?>"/>
        </div>
        <?php if ($cmsportal) { ?>
