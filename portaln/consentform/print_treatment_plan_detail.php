...
<head>
    ...
    <link rel=stylesheet href="/openemr/interface/themes/style_oemr4.css?v=41" type="text/css">
    <!-- stylesheets -->
    <link rel=stylesheet href="/openemr/library/js/bootstrap-3.3.7/css/bootstrap.min.css" type="text/css">
    <link rel=stylesheet href="/openemr/library/js/bootstrap-datepicker/bootstrap-datepicker.min.css" type="text/css">
    <link rel=stylesheet href="/openemr/interface/themes/style-form-print.css" type="text/css">
    <link rel=stylesheet href="/openemr/interface/themes/bootstrap_reset.css" type="text/css" media="screen"
          charset="utf-8">
    <!--[if lt IE 9]>
    <script src="https://html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->
    <!-- supporting javascript code -->
    <script type="text/javascript" src="/openemr/library/js/jquery-2.0.2.min.js"></script>
    <script type="text/javascript" src="/openemr/library/js/bootstrap-3.3.7/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/openemr/library/js/bootstrap-sidebar.js"></script>
    <script type="text/javascript" src="/openemr/library/js/bootstrap-datepicker.min.js"></script>
    <script type="text/javascript" src="/openemr/library/js/jquery.columnizer.js" charset="utf-8"></script>
    <script language="JavaScript">
        // required for textbox date verification
        var mypcc = '1';

        // function PrintForm() {
        //     newwin = window.open("/openemr/interface/forms/soap_pirc/print.php?id=8092", "mywin");
        // }
    ...
    <div class='header'>
        ...
        <div class="info">
            ...
            <div class="form-info">
                ...
                <span>DOB:</span><?= $result['DOB']; ?><br>
                <span>SS#:</span><?= $result['ss']; ?>
                <span>Date of Service:</span><?= substr($dos["date"], 0, 10); ?><br>
                <span>Admission Date:</span><?= substr($dos["date"], 0, 10); ?>
                <span>Clinician:</span><?= $rendering_provider["fname"] . ' ' . $rendering_provider["mname"] . ' ' . $rendering_provider["lname"]; ?>
                <br>
                <span>Sex:</span><?= $result['sex']; ?>
    ...
    <form>
        ...
        <div id="signature" class="form-group group">
            ...
            <div onload="onReturnSampleSigAll()">
                <!--PATIENT SIGNATURE-->
                <p><?= $treatmentPlan['patient_signature'] ?></p>
                <br>
                ...
                <div>
                    <b>Counselor:&nbsp;</b>(Electronically signed
                    by)<?php echo stripslashes($obj{"provider_print_name"}); ?>
                ...
                <div>
                    <b>Clinical Supervisor:&nbsp;</b>(Electronically signed
                    by)<?php echo stripslashes($obj{"supervisor_print_name"}); ?>
                ...
                <label class="description" for="supervisor_print_name"> </label>
                <div>
                    <b>Medical Director (License Clinician):&nbsp;</b>(Electronically signed
                    by)<?php echo stripslashes($obj{"physician_print_name"}); ?>
                    ,&nbsp;<?php echo stripslashes($obj{"physician_credentials"}); ?>
