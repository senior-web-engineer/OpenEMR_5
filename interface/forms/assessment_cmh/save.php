...
$encounter = date("Ymd");
if ($_GET["mode"] == "new"){
$newid = formSubmit("form_assessment_cmh", $_POST, $_GET["id"], $userauthorized);
print 'formSubmitt';  /*debugging */
addForm($encounter, "In-Depth Assessment", $newid, "assessment_cmh", $pid, $userauthorized);
}elseif ($_GET["mode"] == "update") {
$id = 0 + (isset($_GET['id']) ? $_GET['id'] : '');
sqlInsert("update form_assessment_cmh set pid = {$_SESSION["pid"]},groupname='".$_SESSION["authProvider"]."',user='".$_SESSION["authUser"]."',authorized=$userauthorized,activity=1, date = NOW(), 
dcn='".$_POST["dcn"]."', 
