		        ...
		        function onDone1()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/assessment_cmh/save_patient_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
				...
				function onDone2()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/assessment_cmh/save_guardian_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
					...
					function onDone5()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/assessment_cmh/save_physician_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
...
<body onload="onReturnSampleSig3()" class="padding-20">
