...
?>
	...
	<div class="style5">
<span class="title"><strong>Progress Note</strong></span>
<span class="title"><strong>Provider Signature Page</strong></span><br><br>

	</div>
<form method=post action="<?php echo $rootdir?>/forms/progress_note/save.php?mode=update&id=<?php echo $_GET["id"];?>" name="SigForm" id="SigForm">
		        ...
		        function onDone1()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/progress_note/save_patient_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
				...
				function onDone2()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/progress_note/save_guardian_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
					...
					function onDone5()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/progress_note/save_physician_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
...
<!------tabs top---------->
						...
						<!--  <li class="active"><a data-toggle="pill" href="#physician_signature">Physician</a></li> -->
							  <li class="active"><a data-toggle="pill" href="#supervisor_signature">Provider</a></li>
								</ul>
							</div>
<!------end tabs top---------->
