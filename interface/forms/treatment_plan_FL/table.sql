...
ALTER TABLE `openemr`.`form_treatment_plan` 
ADD COLUMN `comments_log` LONGBLOB NULL AFTER `status`;
ALTER TABLE `openemr`.`form_treatment_plan` 
ADD COLUMN `signatures_on_file` VARCHAR(3) NULL DEFAULT NULL AFTER `provider`;
