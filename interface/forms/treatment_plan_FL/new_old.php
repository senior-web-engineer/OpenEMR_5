...
<html lang="en">
	...
	<body>
		...
		<div style="margin: 10px;">
		    ...
		    <td>
				<br>
				<br><input type='button' onclick="sendService('H0032','Treatment Plan','new');" value='<?php echo xlt('Start a New Treatment Plan');?>' class="button-css">&nbsp;<br>
				<br><input type='button' onclick="sendService('H0032TS','Treatment Plan Review','new');" value='<?php echo xlt('Start a New Treatment Plan Review');?>' class="button-css">&nbsp;<br>
				<br><input type='button' onclick="sendService('H0032','Treatment Plan','intake');" value='<?php echo xlt('Initial Treatment Plan/Template');?>' class="button-css">&nbsp;<br>
...
?>					
					<input type='button' onclick="sendService('H0032TS','Treatment Plan Review','clone');" value='<?php echo xlt('Copy');?>' class="button-css">&nbsp;<br>
