		        ...
		        function onDone1()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/treatment_plan/save_patient_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
				...
				function onDone2()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/treatment_plan/save_guardian_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
				...
				function onDone3()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/treatment_plan/save_provider_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
					...
					function onDone4()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/treatment_plan/save_supervisor_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
					...
					function onDone5()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/treatment_plan/save_physician_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
...
<body onload="onReturnSampleSig2()">
...
<!------tabs top---------->
							<div class="row">
							  <ul class="nav nav-tabs" style="font-size: small">
								<!--<li class="active"><a data-toggle="pill" href="#patient_signature">Patient</a></li>-->
								<li class="active" ><a data-toggle="pill" href="#guardien_signature">Guardian</a></li>
								<!--<li><a data-toggle="pill" href="#provider_signature">Provider</a></li>
								<!--<li><a data-toggle="pill" href="#supervisor_signature">Supervisor</a></li>
								<!--<li><a data-toggle="pill" href="#physician_signature">Physician</a></li>-->
								</ul>
							</div>
<!------end tabs top---------->
...
<!-- GUARDIAN SIGNATURE-->
<div id="guardien_signature"class="tab-pane fade in active">
...
<!--PHYSICIAN-->
<div id="physician_signature" class="tab-pane fade">
