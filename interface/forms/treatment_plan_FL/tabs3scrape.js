	...
	var scrapeTP = function(){
		var obj = {
			...
			id : $('#form_id').val(),
			modality : $('#treatmentplan_modality').val(),// Yves 04-29-2017
	...
	var scrapeProblems = function(){
		var obj = {
			...
			Description : $('#problems_Description').val(),
	...
	var scrapeGoals = function(){
		var obj = {
			...
			Description : $('#goals_Description').val(),
	...
	var scrapeObjectives = function() {
		var obj = {
			...
			Description : $('#objectives_Description').val(),
	...
	var scrapeInterventions = function() {
		var obj = {
			...
			Description : $('#interventions_Description').val(),
...
//			duration_hour : $('#modalities_duration_hour').val(),
//			duration_minute : $('#modalities_duration_minute').val(),
...
//	};
	...
	var fillGoals = function(obj) {
		$("#goals_Description").val(obj.Description || "");
	...
	var fillObjectives = function(obj) {
		$("#objectives_Description").val(obj.Description || "");
	...
	var fillInterventions = function (obj) {
	    $("#interventions_Description").val(obj.Description || "");
