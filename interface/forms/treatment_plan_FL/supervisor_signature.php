...
<body onload="onReturnSampleSig4()">
...
<!------tabs top---------->
							<div class="row">
							  <ul class="nav nav-tabs" style="font-size: small">
								<li class="active"><a data-toggle="pill" href="#supervisor_signature">Supervisor</a></li>
							  </ul>
							</div>
<!------end tabs top---------->
...
<!--SUPERVISOR-->
<div id="supervisor_signature" class="tab-pane fade in active">
...
<?php echo '__   '. $provider_results["supervisor"];
if ($provider_results["supervisor"] != '')
{
?>
<script language="javascript">
