...
<body onload="onReturnSampleSig3()">
...
<!------tabs top---------->
							<div class="row">
							  <ul class="nav nav-tabs" style="font-size: small">
								<li class="active" ><a data-toggle="pill" href="#provider_signature">Provider</a></li>
							  </ul>
							</div>
<!------end tabs top---------->
...
<!--PROVIDER -->
<div id="provider_signature" class="tab-pane fade in active">
