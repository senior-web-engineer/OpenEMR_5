...
while ($row = mysqli_fetch_array($result)) {
  ...
  $dropdown1 .= "<select class='form-control' id='clone_tpid'>";
foreach ($rows as $row) {
...
?>				
					...
					<input class="btn btn-primary" type='button' onclick="sendService('H0032TS','Treatment Plan Review','clone');" value='<?php echo xlt('Copy');?>' class="button-css">&nbsp;<br>
				<!--<br><input type='button'  value="Print" onclick="window.print()" class="button-css">&nbsp;-->
				<br><input class="btn btn-danger" type='button' class="button-css" value='<?php echo xlt('Cancel');?>'
