		...
		<div class="tabbable">
						...
						<!------Tab Strengths ---------->
							...
							<div class="tab-content row">
							   <div id="strength" class="tab-pane fade in active col-md-9">
									...
									<button id="addStrength" class="btn" >Add Strength</button><br/>
										...
										<div class="section hidden editor" >
											<button type="button" class="close"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
											<textarea class="textarea-sm"  id="strength_Description" style="height: 86px"  ></textarea><br/>
											<div data-bind="tiControl: {
							...
							<div id="weakness" class="tab-pane fade col-md-9">
									...
									<button id="addWeakness" class="btn" >Add Weakness</button><br/>
										...
										<div class="section hidden editor" >
											<button type="button" class="close"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
											<textarea class="textarea-sm"  id="weakness_Description" style="height: 86px"  ></textarea><br/>
											<div data-bind="tiControl: {
									...
									<div class="section">
										...
										<div class="section editor hidden">
											...
											<!--<div id="review"  style="display:none;">-->
												...
												<strong>Status:</strong><select id='goals_goal_status'>
													<option>Achived</option>
													<option>Improved</option>
													<option>No Change</option>
													<option>Worse</option>
												</select>
									<strong>Goal Action:</strong><select id='goals_goal_action'>
											...
											<textarea class="textarea-lg" id="goals_review_status"></textarea>
								...
								<div id="objectives_1" class="tab-pane fade col-md-9">
									<div class="section">
										...
										<div class="section editor hidden">
											...
											Target Date: <input type="date" class="datepicker" data-date-format="yyyy/mm/dd" id='objectives_target_date' />
								...
								<div id="modalities_1" class="tab-pane col-md-9">
									<div class="section" > 
										...
										<div class="section editor hidden">
											...
											<p><b>Start Date</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
											<b>End Date</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
											<input type="date" class="datepicker" data-date-format="yyyy/mm/dd" id="modalities_start_date">
											<input type="date" class="datepicker" data-date-format="yyyy/mm/dd" id="modalities_end_date">
											<br>
											<br>
											<b>Service And Code</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<br>
			...
			<td>
				...
				//if (acl_check('acct', 'rep_a')) {
					...
					echo "   &nbsp;<input type='text' list='modalities_provider' placeholder='Provider' >\n";
					echo "   &nbsp;<datalist id='modalities_provider'>\n";
									...
									<div class="section" id="diagnosissection1">
										...
										<div class="section hidden editor" >
											...
											<div data-bind="tiControl: {
																...
																page: 'treatment_plan/edit.php',
																storeid: ['diagnosis_LegalCode','diagnosis_GroupID'] ,
																appendvalue: false,
																params: {id1: 0}
																}, tiVM: $data"></div>
											<span  class="dev" >
