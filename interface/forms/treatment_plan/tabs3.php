          ...
          <div class="smartwizard-content">
            <div id="step-1" class="">
              ...
              <div style="margin-bottom: 30px;">
                <button class="btn btn-primary" id="btn-add-diagnosis" onclick="createNewDiagnosis()" disabled>Add Diagnosis</button>
              </div>
            ...
            <div id="step-4" class="">
              ...
              <div class="step-content-body">
                ...
                <div id="objectiveSplitter" style="height: 400px;">
                    ...
                    <div style="border: none;" id="objectiveExpander">
                      ...
                      <div class="goals-area" style="padding: 0">
                        <div class="goals-panel">
                          <div class="list-group" id="goal-tab" style="margin:0">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div style="overflow: auto">
                    <div style="margin: 10px; margin-bottom: 30px;" class="create-objective">
                      <button class="btn btn-primary" id="btn-add-objective" onclick="createNewObjective()" disabled>
                        Add Objectives
                      </button>
                    </div>
            ...
            <div id="step-5" class="">
              ...
              <div class="step-content-body">
                ...
                <div id="interventionSplitter">
                    ...
                    <div style="border: none;" id="interventionExpander">
                      ...
                      <div class="objectives-area" style="padding: 0">
                        <div class="objectives-panel">
                          <div class="list-group" id="objective-tab" style="margin:0">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div style="overflow: auto">
                    <div style="margin: 10px; margin-bottom: 30px;" class="create-intervention">
                      <button class="btn btn-primary" id="btn-add-intervention" onclick="createNewIntervention()" disabled>
                        Add Interventions
                      </button>
                    </div>
                    <div class="list-group" id="intervention-contents">
                    </div>
                  </div>
                </div>
              </div>
