...
function loadDiagnosisOptions(problemNumber, groupID) {
    ...
    //const   params = {id1: form_id, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id0: libraryId}; //Yves
    //const   params = {id1: form_id, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: problemNumber, id0: libraryId};
    //const   params = {id1: groupID, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: form_id, id5: problemNumber, id0: libraryId};
    //const   params = {id1: groupID, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: form_id, id5: problemNumber, id0: libraryId};
    const params = { id1: groupID, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: problemNumber, id0: libraryId };
    //const   params = {id1: groupID, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: form_id, id5: problemNumber, id0: libraryId};
    //const   params = {id1: groupID, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: selectedProblemId, id0: libraryId};
    //const   params = {id1: form_id, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id4: problemNumber, id0: libraryId}; //Yves
    //const   params = {id1: groupID, api: 'getSelectorData', controlid: diagnosisHeading.selectors[0].id, id3: problemNumber, id4: problemnumber, id0: libraryId};
    $.ajax({
        url: selectorPath,
        type: 'POST',
        data: params,
...
function loadDiagnosis() {
    ...
    $.ajax({
        ...
        success: function (resData) {
            ...
            //YVES 07-11-2020 Start

            //	if (arrDiagnosis) {
            //
            //                arrDiagnosis.forEach(function(element) {
            //                    loadDiagnosisOptions(element.ProblemNumber, element.GroupID, element.id);
            //                    loadDiagnosis(element.id);
            //                });
            //
            //           }
            //YVES 07-11-2020 ^^^^^^^			
