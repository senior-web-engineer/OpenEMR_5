		...
		function onSign1() 
						{
						  ...
						  var ctx1 = document.getElementById('cnv1').getContext('2d');
						   SetDisplayXSize( 500 );
						   SetDisplayYSize( 100 );
						   SetJustifyMode(0);      
						   ClearTablet();
								...
								function(data) {
								  if($.trim(data).length > 0){
								  		var ctx4 = document.getElementById('sigplus4').getContext('2d');         
   											...
   											SetJustifyMode(0);
   											ClearTablet();
 										var  tmr = SetTabletState(1, ctx4, 50) || tmr;								  	
								  //document.getElementById('sigplus2').sigString =  "<?php echo $signature_result; ?>";
                                    var mySig4 = data;
                                    SetSigString(mySig4, ctx4);
   									SetJustifyMode(0);
...
<canvas id="cnv5"name="cnv5" width="400" height="80">

</canvas>

<br>
<input id="SignBtn1" name="SignBtn1" type="button" value="Sign1"  onclick="javascript:onSign1()"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- GUARDIAN SIGNATURE-->
<canvas id="sigplus2"  name="sigplus2"" width="400" height="80">

</canvas>

<br>
<input id="SignBtn2" name="SignBtn2" type="button" value="Sign2"  onclick="javascript:onSign2()"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--START PROVIDER SIGNATURE-->
  <tr>
    <td height="10" width="500">
<canvas id="sigplus3" name="sigplus3" width="400" height="80">

</canvas>
<br>
<input id="SignBtn3" name="SignBtn" type="button" value="Sign3"  onclick="javascript:onSign3()"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--START SUPERVISOR SIGNATURE-->

<canvas id="sigplus4" name="sigplus4" width="400" height="80">

</canvas>

<br>
<input id="SignBtn4" name="SignBtn4" type="button" value="Sign4"  onclick="javascript:onSign4()"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--START PHYSICIAN SIGNATURE-->
<canvas id="sigplus5" name="sigplus5" width="400" height="80">

</canvas>
<br>

<input id="SignBtn5" name="SignBtn5" type="button" value="Sign5"  onclick="javascript:onSign5()"/>&nbsp;&nbsp;&nbsp;&nbsp;
