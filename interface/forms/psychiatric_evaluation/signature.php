          	  ...
          	  function onReturnSampleSig1()
					{
     					...
     					var mySig1 = "<?php echo  stripslashes($obj{"physician_signature"});?>";
		        ...
		        function onDone1()
							{
								...
								$.post("<?php echo $GLOBALS['webroot'] ?>/interface/forms/psychiatric_evaluation/save_physician_signature.php?mode=update&id=<?php echo $_GET['id'];?>",
										{physician_print_name: $("#physician_print_name").val() ,credentials: $("#credentials").val() , sig_date: $("#sig_date").val(), physician_signature: $('#sigStringData').val()},
											function(data) 
												{
...
<!--<body onload="drivertest()">-->
						...
						<label class="description" for="provider_print_name"> </label>
							...
							<b>Clinician Print Name:</b> <input id="physician_print_name" name="physician_print_name"  class="element text medium" type="text" value="<?php echo stripslashes($obj{"physician_print_name"});?>"   required />
							<b>Credentials:</b> 
							<input id="physician_credentials" name="physician_credentials"  class="element text medium" type="text" value="<?php echo stripslashes($obj{"physician_credentials"});?>" style="width: 75px"   required />
							<label>Signature Date:</label>
							<input type='text' size='10' name='physician_signature_date' id='physician_signature_date' value="<?php echo stripslashes($obj{"physician_signature_date"});?>" title='<?php xl('yyyy-mm-dd','e'); ?>' onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)' required />
						...
						<div id="topaz">	
							...
							<br>
							<b>PIN:</b><input id="physician_pin" name="physician_pin"  class="element text medium" type="password" value="" style="width: 35px"   />
