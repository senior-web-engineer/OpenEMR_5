...
var mypcc = '<?php echo $GLOBALS['phone_country_code'] ?>';
   ...
   var Index;
	...
	var cursig=0;
              ...
              function onReturnSampleSig()
					{
     					...
     					var mySig = "<?php echo  stripslashes($obj{"physician_signature"});?>";
		   ...
		   if(cursig == 1)
		   {
		      document.SigForm.bioSigData.value = GetSigString(); //assign sigstring to hidden field
		      document.SigForm.sigStringDataText.value = document.FORM1.bioSigData.value; //show current sigstring data in text area
		   }
		...
		<div id="GroupA" class="form-group group">
			<div class="form-inline">
				...
				<div class="collapse" id="collapse_info_other">
					...
					<input id="info_source_other" name="info_source" class="form-control" type="text" value="<?php echo stripslashes($obj{"info_source"});?>"/>
				</div>
			</div>
			<div class="form-inline">
	...
	$(".small_modal").fancybox( {
	    ...
	    type: 'iframe'
			...
			<div id="physician_signature" class="">
				...
				<td valign="top" class="text"><b><a href="<?php echo "$web_root";?>/interface/forms/psychiatric_evaluation/physician_signature.php?dev=1&formid=<?php echo "$formid";?>" class="various" data-fancybox-type="iframe"><span>Click Here for Physician Signature Page</span></a></b>&nbsp;</td>
       		</div><!--END  PHYSICIAN SIGNATURE-->
<!--OLD SIGNATURE Yves 07-31-2017
				<canvas id="sigplus" width="400" height="80" style="border:1px solid #000000;"></canvas>
				<br>
				<input id="SignBtn" name="SignBtn" type="button" value="Sign"  onclick="javascript:onSign()"/>&nbsp;&nbsp;&nbsp;&nbsp;
				<input id="clear" name="ClearBtn" type="button" value="Clear" onclick="javascript:onClear()"/>&nbsp;&nbsp;&nbsp;&nbsp;
	<!--
...
<!--			<label>PIN:<input id="physician_pin"  class="form-control element text medium" type="password" value="" style="width: 50px" /></label>
				...
				<br>
				<input id="button" name="StopBtn" type="button" value="Done" onclick="javascript:onDone()"/>&nbsp;&nbsp;&nbsp;&nbsp;
			</div><!--END  PHYSICIAN SIGNATURE-->	
		<INPUT TYPE=HIDDEN NAME="bioSigData">
		<INPUT TYPE=HIDDEN NAME="sigStringData" id="sigStringData" value="<?php echo  stripslashes($obj{"physician_signature"});?>">
		...
		<div id="GroupU" class="form-group group form-inline update-info">
			...
			<input type="hidden" name="encounter" id="encounter" value="<?php echo $encounter; ?>" readonly>
		</div>
	</form>
	</div><!--/left-->
