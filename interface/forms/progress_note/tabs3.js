            ...
            _.each(oList, function (item) {
                if (!_.isUndefined(item)) {
                    ...
                    switch (editorType) {
						...
						case "intervention_item":
						list += "&nbsp;<b>Status Description: </b><span>" + item.Description + "</span>";
                    	    
	                   	break;


                    	case "modality_item":
                    		//list += "&nbsp;<b>Description: </b><span>" + item.Description + "</span>";
        ...
        switch (editorType) {
            case "problem_item":
                ...
                if (!_.isUndefined(obj)) {
                    fillProblems(obj);
                    var tiVM = ko.contextFor($("#problems_Description_2").get(0)).$data;
                    tiVM.updateControl({
            ...
            case "goal_item":
                ...
                if (!_.isUndefined(obj)) {
                    ...
                    var tiVM = ko.contextFor($("#goals_Description_2").get(0)).$data;
                    tiVM.updateControl({
            ...
            case "objective_item":
                ...
                if (!_.isUndefined(obj)) {
                    ...
                    var tiVM = ko.contextFor($("#objectives_Description_2").get(0)).$data;
                    tiVM.updateControl({
            ...
            case "intervention_item":
                ...
                if (!_.isUndefined(obj)) {
                    ...
                    var tiVM = ko.contextFor($("#interventions_Description_2").get(0)).$data;
                    tiVM.updateControl({
    ...
    var itemListClickHandler = function () {
        ...
        switch (editorType) {
            case "objective_item":
                ...
                var params = { api: "getinterventions", form_id: form_id, problem_id: problem_id };
