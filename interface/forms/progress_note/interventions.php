...
<div class="row">
	...
	<div class="col-md-12">
		<h2>Progress Note (Select Problem):</h2>
						...
						<div class="container">
							...
							<div class="row">
							  <ul class="col-md-9 nav nav-pills">
								<!--<li class="active"><a data-toggle="pill" href="#problem_definitions_1">Problems</a></li>-->
...
<?php
if ($form_name == "IND" OR $form_name == "GRP" )
{
?>
							...
							<div class="tab-content row">
								...
								<div id="modalities_1" class="tab-pane col-md-9">
									<div class="section" > 
										...
										<button id="addModality" class="btn">Add Intervention</button><br/>
										<p>Intervention:</p>
