...
<!--<body onload="drivertest()">-->
	...
	<div id="physician_signature" class="">
				...
				<a href="<?php echo "$web_root";?>/interface/forms/progress_note/provider_signature.php?dev=1&formid=<?php echo "$formid";?>" class="various" data-fancybox-type="iframe">
	...
	<div id="supervisor_signature" class="">
				...
				<td valign="top" class="text"><b>
				<a href="<?php echo "$web_root";?>/interface/forms/progress_note/supervisor_signature.php?dev=1&formid=<?php echo "$formid";?>" class="various" data-fancybox-type="iframe">
