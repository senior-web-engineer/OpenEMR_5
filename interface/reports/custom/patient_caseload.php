...
$query = "SELECT ".
" pd.pid, pd.fname, pd.lname, pd.mname, pd.sex, pd.postal_code, pd.city, pd.patient_active, pd.providerID, pd.group_providerID,".
...
$grplname = $row['grplname'];
	...
	echo "<tr><td class='style1'> " . $id. "</td><td class='style1'> " .$lname."</td><td class='style1'> " . $mname."</td><td class='style1'> " . $fname."</td><td class='style1'> " . $sex."</td><td class='style1'> ". $city."</td><td class='style1'> ". $postal_code."</td><td class='style1'> " .$patient_active."</td><td class='style1'> ". date("m-d-Y", strtotime($lastdate)). "</td><td class='style1'> ". $plname. ", " .$pfname. "</td><td class='style1'> ". $grplname. ", " .$grpfname;
