...
$sql = "SELECT ". 
	"fr.id, fr.pid, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.goal, fr.subjective, fr.objective, fr.assessment, fr.plan".
	...
	"AND form_name = 'Progress Note - IND'  ".
...
<div>
	...
	<div class="notes">
		<h2>Goal</h2>
		<p><?php echo stripslashes($row{"goal"});?></p>		
		<h2>Subjective</h2>
		<p><?php echo stripslashes($row{"subjective"});?></p>
		<h2>Objective</h2>
		<p><?php echo stripslashes($row{"objective"});?></p>
		<h2>Assessment</h2>
		<p><?php echo stripslashes($row{"assessment"});?></p>
		<h2>Plan</h2>
		<p><?php echo stripslashes($row{"plan"});?></p>
