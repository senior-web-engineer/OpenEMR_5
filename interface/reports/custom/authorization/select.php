...
<FORM ACTION="authorization_utilization.php" METHOD=POST TARGET="_blank" id="ProviderSelect" name="ProviderSelect">
<?php
...
<div class="form-group col-sm-12">
	...
	<select name="service_code" >
			...
			<option value="T1015">T1015 Med Management</option>
	</select>
</div>
<br>
<input id="SignBtn" name="SignBtn" class="btn btn-primary" type="submit" value="Submit"  ><br><br>
