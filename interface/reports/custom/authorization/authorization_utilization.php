...
<thead> 
		<tr>
			...
			<th class='auto-style1' style="width: 80px">Units/Visits Allowed</th>
			<th class='auto-style1'>Start</th>
			<th class='auto-style1'>End</th>
			<th class='auto-style1'>Service Provided</th>
...
if ($service_code == ""){
						...
						$service_code_filter = "AND au.service_code = '$service_code' ";
	}

if ($provider == ""){
					$provider_filter = "";
					}else{
					$provider_filter = "AND (p.providerID = $provider OR p.group_providerID = $provider) ";
