...
switch ($form_selected) {
    ...
    $form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.service_code, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end, fr.subjective, fr.objective, fr.assessment, fr.plan";
    break;
	case "form_progress_note_psr":
	$form_selected = "form_progress_note";
         $form_name = "Progress Note - PSR";
         $extra_fields = ", fr.service_code, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end,fr.deficit_problems_behavior_addressed, fr.interventions, fr.response_to_intervention";
    break;
