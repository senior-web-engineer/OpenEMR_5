...
switch ($form_selected) {
    ...
    $form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end";
    break;
