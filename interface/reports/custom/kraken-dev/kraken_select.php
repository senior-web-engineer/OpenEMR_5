...
function ActionDeterminator() {
  ...
  if(document.myform.form_selected[1].selected == true) {
    document.myform.action = 'kraken_psr.php';
    //document.myform.method = 'get';					 // SOAP
  }
  if(document.myform.form_selected[2].selected == true) {
    document.myform.action = 'kraken_psr.php';			 // PSR
    }
  if(document.myform.form_selected[3].selected == true) {
    document.myform.action = 'kraken_psr.php';			 // Group Note
    }
  
  if(document.myform.form_selected[4].selected == true) {
    document.myform.action = 'kraken_service.php';// Med Management

  }
  if(document.myform.form_selected[5].selected == true) {
    document.myform.action = 'kraken_service.php';// CFARS

  }
  if(document.myform.form_selected[6].selected == true) {
    document.myform.action = 'kraken_service.php';// FARS

  }
  if(document.myform.form_selected[7].selected == true) {
    document.myform.action = 'kraken_service.php';//Treatment Plan

  }
	if(document.myform.form_selected[8].selected == true) {
    document.myform.action = 'kraken_service.php';// Treatment Plan Review

  }
  if(document.myform.form_selected[9].selected == true) {
    document.myform.action = 'kraken_service.php';//Psych Eval

  }
	if(document.myform.form_selected[10].selected == true) {
    document.myform.action = 'kraken_service.php';//form_assessment_cmh

  }
	if(document.myform.form_selected[11].selected == true) {
    document.myform.action = 'kraken_service.php';//form_brief_mental_status_cmh
  }
	if(document.myform.form_selected[12].selected == true) {
    document.myform.action = 'kraken_service.php';//form_form_vitals
  }
...
<form NAME="myform" ACTION="kraken_psr.php2" METHOD=POST TARGET="_blank" class="form-inline">
...
<div class="form-group col-sm-12">
	...
	<select name="form_selected" class="form-control">
	        ...
	        <option value="form_group_note">Group Note</option>
			...
			<option value="form_psychiatric_evaluation">Psychiatric Evaluation</option>
			<option value="form_assessment_cmh">Assessment</option>
			<option value="form_brief_mental_status_cmh">Brief Mental Health Status</option>
			<option value="form_form_vitals">Vitals</option>
...
<div class="form-group col-sm-12">
	...
	<select name="billing_code_type" class="form-control">
	        <option value="">-----</option>
	        <option selected value="HCPCS">HCPCS - Medicaid and MMA's</option>
	        <option value="CPT">Medicare and Most Commercial</option>
	</select>
</div>
