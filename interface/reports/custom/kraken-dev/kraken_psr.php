...
$sql = "SELECT ". 
	...
	", pl.pid, MAX(pl.provider) AS plprovider, pl.type, pl.plan_name AS plplan_name, pl.policy_number AS plpolicy_number, MAX(pl.id), MAX(pl.date) AS pldate".
	...
	$date_created_select.
	$patient_select.
	"GROUP BY fr.id LIMIT 5"
	//"ORDER BY pldate DESC "
