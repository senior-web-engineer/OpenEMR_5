...
<th class='auto-style1'>PID</th>       
	...
	<th class='auto-style1'>First Name</th><th class='auto-style1'>Provider</th>  <th class='style4'><B>Last Encounter</B></th>
	<th class='auto-style1'> Days Since Last Encounter</th> 
	<!--<th class='style4'><B>Last Treatment Plan</B></th>--> 
	<!--<th class='auto-style1'>Days Since Last TP</th> <th class='style4'><B>Last Treatment Plan Review</B></th>--> 
	<!--<th class='style4'>Days Since Last TP/R</th><th class='style4' style="width: 95px"><B>Last C/FARS</B></th>-->
	<!--<th class='auto-style1'>Days Since Last C/FARS</th>-->
		<th class='style4'><B>Last Psych Eval</B></th>
	<th class='auto-style1'> Days Since Last Psych Eval</th></tr></thead><tbody>
<?php
...
if ($provider == ''){
		$select_proviser = '';
		}else{$select_provider = 'AND p.providerID = $provider ';
					}
$db_name = "openemr";
...
$connection = @mysql_connect("localhost", "root", "4050!Pirc") or die(mysql_error());
...
"AND f.form_name = 'New Patient Encounter' "
."GROUP BY f.form_id "
...
//	", tp.provider_print_name, tp.servicecode, tp.id ".
//"FROM forms AS f ".
//	"JOIN form_encounter AS e ON e.encounter = f.encounter ".
//	"LEFT JOIN form_individualized_treatment_plan_cmh AS tp ON tp.id = f.form_id ".
//"WHERE (f.deleted = '0' AND f.pid = $pid) ".
//	"AND (f.form_name = 'Individualized Treatment Plan' OR f.form_name = 'Treatment Plan - Uploaded') ".
//	"AND tp.servicecode = 'H0032' "
//."GROUP BY e.date "
//."ORDER BY f.form_id DESC "
...
//	"f.pid, f.encounter, f.form_id, f.form_name, f.deleted,".
//	" MAX(e.date) AS edate, e.encounter".
//	", tp.provider_print_name, tp.servicecode AS servicecode_3, tp.id ".
//"FROM forms AS f ".
//	"JOIN form_encounter AS e ON e.encounter = f.encounter ".
//	"LEFT JOIN form_individualized_tpr AS tp ON tp.id = f.form_id ".
//"WHERE (f.deleted = '0' AND f.pid = $pid) ".
//	"AND (f.form_name = 'Individualized Treatment Plan Review') ".
//	"AND tp.servicecode = 'H0032TS' "
//."GROUP BY e.date "
//."ORDER BY f.form_id DESC "
...
//$result_4 = @mysql_query($sql_4,$connection) or die(mysql_error());
...
;
$result_5 = @mysql_query($sql_5,$connection) or die(mysql_error());
...
echo "<tr><td class='style1'>$pid</td><td class='style1'><b>$lname</b></td> <td class='style1'><b>$fname</b></td><td class='style1'>$prlname, $prfname</td>";
...
echo "</B></td><td class='style1'>";
 if ($elapsetime_1 <= 70)
	 ...
	 echo "<span style=\"color: #FF0000\"> No Encounter on record</span>";
...
//	 echo "<span style=\"color: #FF0000\"> No Treatment Plan on record</span>";
...
//		else if ($elapsetime_3 >= 71 && $elapsetime_3 <=90)
//	 echo "<span style=\"color: #FFA500\"><strong> ". $elapsetime_3."</strong></span>";
//	else if ($elapsetime_3 >= 91 && $elapsetime_3 <= 4999)
//	 echo "<span style=\"color: #FF0000\"><strong> ". $elapsetime_3."</strong></span>";
//	else if ($elapsetime_3 >= '5000')
//	 echo "<span style=\"color: #FF0000\"> No Treatment Plan Review on record</span>";
...
if ($elapsetime_5 <= 340)
	 ...
	 echo "<span style=\"color: #FF0000\"> No Psych Eval on record</span>";
