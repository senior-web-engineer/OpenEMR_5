...
<span class='title'><?php xl('Report','e'); ?> - <?php xl('Unique Seen Patients 2','e'); ?></span>

<div id="report_parameters_daterange">
<?php echo date("d F Y", strtotime($form_from_date)) ." &nbsp; to &nbsp; ". date("d F Y", strtotime($form_to_date)); ?>
</div>

<form name='theform' method='post' action='unique_seen_patients_report_DEV.php' id='theform'>
...
//   "c2.id = i2.provider " .
   "GROUP BY p.lname, p.fname, p.mname, p.pid, i1.date " .
//   ", i2.date " .
   "ORDER BY p.lname, p.fname, p.mname, p.pid, i1.date DESC ";
//   ", i2.date DESC";
