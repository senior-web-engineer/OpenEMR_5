...
<!-- Form Info -->
		<div class="panel panel-default">
			...
			<span><b>Ins:&nbsp;</b></span><?php echo $insurance;?>----<?php echo $billed;?>_-_<?php echo $row['pl_policy_number'];?>
<!--//in.pid, in.provider AS inprovider, in.type, in.policy_number-->
			<span><br><b>Insurance:&nbsp;</b></span><?php echo $row['pl_provider'];?>-<?php echo $row['pl_plan_name'];?>-<?php echo $row['po_name'];?>-<?php echo $row['po_billing_code_type'];?>-Effective 
			Date:<?php echo $row['pldate'];?><br>
			<b>Insurance API:</b><?php echo $company;?><br>
			<span><b>Code Type:&nbsp;</b></span><?php echo $row['po_billing_code_type'];?><br>
			<span><b>Encounter:&nbsp;</b></span><?php echo $row['en_counter'];?>_<?php echo $fm_encounter;?>_<?php echo $en_encounter;?><br>
			...
			<span><b>Service Authorized:&nbsp;</b></span><?php echo $row['sa_service_code'];?>
