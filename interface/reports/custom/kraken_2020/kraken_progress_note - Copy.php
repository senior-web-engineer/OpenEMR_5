...
switch ($form_selected) {
    case "form_psychosocial":
         ...
         $extra_fields = ", fr.servicecode, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.clinical_intervention, fr.response_to_intervention, fr.credentials, fr.sig_date, fr.provider_id, fr.provider_print_name, fr.timestart, fr.timeend";
    break;
    case "form_soap_pirc":
         $form_name = "SOAP Notes";
         $extra_fields = ", fr.servicecode, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.objective, fr.subjective, fr.assessment, fr.plan, provider_credentials, provider_signature_date, fr.provider_print_name, fr.timestart, fr.timeend";
    break;
    case "form_med_management":
         $form_name = "Medication Management";
         $extra_fields = ", fr.servicecode, units, fr.complaint";
    break;
     case "form_assessment_cmh":
         $form_name = "In-Depth Assessment";
         $extra_fields = ", fr.service_code, units, provider_credentials, provider_signature_date, fr.provider_print_name";
    break;
    case "form_treatment_plan":
    $form_selected = "form_treatment_plan";
         $form_name = "Treatment Plan";
         $extra_fields = ", fr.service_code, unit, provider_credentials, provider_signature_date, fr.provider_print_name";
    break;
    ...
    $form_selected = "form_cfars";
         $form_name = "FARS";
         $extra_fields = ", fr.servicecode, units, fr.provider_print_name";
    break;
    case "form_cfars":
    $form_selected = "form_cfars";
         $form_name = "CFARS";
    ...
    $form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.service_code, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end";
    break;
...
////			$dropdown1 .= "\r\n</select>";
			...
			echo $row['diagnosis1']. "helllllllllllllllllllllllllllllllllllllllllllllo<br>";
			...
			switch ($form_selected) {
							...
							switch ($form_name) {
							    ...
							    case "Progress Note - PSR":
									...
									$count = 0;
									print "SOAP Notes";
									$data2 = formFetch("form_progress_note", $form_id);
									echo $data2;
									if ($data2) {
									//print "<table>
									//	<colgroup>
...
<table class="selection table" id="selection">
	...
	<div>
		<!--<td><input type="checkbox" name="boxes[<?php echo $i ?>]" style="width: 21px"></td>-->
		<!--<td><input type="checkbox" name="pid[<?php echo $i ?>]" value="<?php echo $pid; ?>" style="width: 84px" readonly></td>-->
		<td><input class="form-control input-sm" type="text" name="pid[<?php echo $i ?>]" value="<?php echo $pid; ?>" style="width: 50px" readonly></td>
		<!--<td><?php echo $pid; ?>&nbsp;</td>-->
		<!--<td><?php echo $en_encounter; ?>&nbsp;</td>-->
		<td><input class="form-control input-sm" type="text" name="en_encounter[<?php echo $i ?>]" value="<?php echo $en_encounter; ?>" style="width: 85px" readonly></td>
		<td><input class="form-control input-sm" type="text" name="form_id[<?php echo $i ?>]" value="<?php echo $form_id; ?>" style="width: 78px" readonly></td>
		<input class="form-control input-sm" type="hidden" name="form_selected[<?php echo $i ?>]" value="<?php echo $form_selected; ?>" style="width: 78px" readonly>
		<td><input class="form-control input-sm" type="text" name="provider_id[<?php echo $i ?>]" value="<?php echo $provider_id; ?>" style="width: 40px"></td>
		<td><input class="form-control input-sm" type="text" name="justify1[<?php echo $i ?>]" value="<?php echo $diag_code1; ?>" style="width: 52px" required ></td>
		<td><input class="form-control input-sm" type="text" name="justify2[<?php echo $i ?>]" value="<?php echo $diag_code2; ?>" style="width: 48px"></td>
		<td><input class="form-control input-sm" type="text" name="justify3[<?php echo $i ?>]" value="<?php echo $diag_code3; ?>" style="width: 52px"></td>
		<td><input class="form-control input-sm" type="text" name="justify4[<?php echo $i ?>]" value="<?php echo $diag_code4; ?>" style="width: 52px"></td>
		<td><input class="form-control input-sm" type="text" id="diag1" name="diag1[<?php echo $i ?>]" value="<?php echo $diag1; ?>" style="width: 84px" required ></td>
		<td><input class="form-control input-sm" type="text" name="diag2[<?php echo $i ?>]" value="<?php echo $diag2; ?>" style="width: 84px"></td>
		<td><input class="form-control input-sm" type="text" name="diag3[<?php echo $i ?>]" value="<?php echo $diag3; ?>" style="width: 84px"></td>
		<td><input class="form-control input-sm" type="text" name="diag4[<?php echo $i ?>]" value="<?php echo $diag4; ?>" style="width: 84px"></td>
		<td><input class="form-control input-sm" type="text" id="code_type1" name="code_type1[<?php echo $i ?>]" value="<?php echo $code_type1; ?>" style="width: 60px" ></td>
		<td><input class="form-control input-sm" type="text" name="code_type2[<?php echo $i ?>]" value="<?php echo $code_type2; ?>" style="width: 63px" ></td>
		<td><input class="form-control input-sm" type="text" name="code_type3[<?php echo $i ?>]" value="<?php echo $code_type3; ?>" style="width: 60px" ></td>
		<td><input class="form-control input-sm" type="text" name="code_type4[<?php echo $i ?>]" value="<?php echo $code_type4; ?>" style="width: 60px" ></td>
		<!--<td><input type="text" name="justify5[<?php echo $i ?>]" value="<?php echo $justify5; ?>"></td>-->
		<td><input class="form-control input-sm" type="text" name="justify[<?php echo $i ?>]" value="<?php echo $justify; ?>" required ></td>
		<td><input class="form-control input-sm" type="text" name="code_type[<?php echo $i ?>]" value="<?php echo $code_type; ?>" style="width: 79px"></td>
		<td><input class="form-control input-sm" type="text" name="servicecode[<?php echo $i ?>]" value="<?php echo substr($servicecode,0,5); ?>" style="width: 79px" required ></td>
		<td><input class="form-control input-sm" type="text" name="modifier[<?php echo $i ?>]" value="<?php echo substr($servicecode,5,2); ?>" style="width: 53px"></td>
		<td><input class="form-control input-sm" type="text" name="units[<?php echo $i ?>]" value="<?php echo $units; ?>" style="width: 25px" required ></td>
		<td><input class="form-control input-sm" type="text" name="fee[<?php echo $i ?>]" value="<?php echo $fee;?>" style="width: 79px" required ></td>
		<td><input class="form-control input-sm" type="text" name="code_text[<?php echo $i ?>]" value="<?php echo $code_text; ?>" style="width: 217px"></td>
	<script language="JavaScript">
	//var linenum = "<?php echo $i ?>";
	var linenum = "1";
$("select[name='diagnosis1[<?php echo $i ?>]']").on("change", function () {
	
    var val = this.value;
    var parts = val.split("_");
    $("input[name='diag1[<?php echo $i ?>]']").val(parts[0]);
    $("input[name='code_type1[<?php echo $i ?>]']").val(parts[1]);
});
</script>

<?php
$query = "SELECT pid, title, diagnosis, type, enddate FROM lists where pid = $pid AND diagnosis LIKE '%ICD10%'and diagnosis NOT LIKE '%F7%' and diagnosis NOT LIKE '%F80%' and diagnosis NOT LIKE '%F84%' and diagnosis NOT LIKE '%F99%';";
		//echo $query;
		// Execute it, or return the error message if there's a problem.
		$resultdiag = $mysqli -> query($query);
			$dropdown1 .= "<select id='diagnosis1' name='diagnosis1[$i]' required ><option selected=''>". stripslashes($obj{"diagnosis1"}). "</option>";
		...
		while($row = mysqli_fetch_array($resultdiag)) {
			//$diagoption = substr($obj["diagnosis1"], strpos($obj["diagnosis1"], ' ') +1);
			$diagoption = $row['diagnosis']. "  ".$row['title'];
			echo "<br><b>diagoption :</b>". $diagoption;
			$diag_decription = substr($diagoption, strpos($diagoption, ' ') +1);
			echo "<br><b>diag_decription :</b>". $diag_decription;
			$diag_complete = substr($diagoption, strpos($diagoption, ':') +1);
			echo "<br><b>diag_complete :</b>". $diag_complete;
			$diag_code = substr($diag_complete, 0, strpos($diag_complete, ' '));

			echo "<br><b>diag_code :</b>". $diag_code;
			$code_type = substr($diagoption, 0, strpos($diagoption, ':'));
			echo "<br><b>code_type :</b>". $code_type;
		
			$dropdown1 .= "\r\n<option value='$diagoption". "_"."{$row['diagnosis']}". "_"."{$row['title']}'>{$row['diagnosis']}". "  "."{$row['title']}</option>";
			$dropdown2 .= "\r\n<option value='$diagoption". "_"."{$row['diagnosis']}". "_"."{$row['title']}'>{$row['diagnosis']}". "  "."{$row['title']}</option>";
			$dropdown3 .= "\r\n<option value='$diagoption". "_"."{$row['diagnosis']}". "_"."{$row['title']}'>{$row['diagnosis']}". "  "."{$row['title']}</option>";
			$dropdown4 .= "\r\n<option value='$diagoption". "_"."{$row['diagnosis']}". "_"."{$row['title']}'>{$row['diagnosis']}". "  "."{$row['title']}</option>";
		}
