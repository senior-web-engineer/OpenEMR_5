...
switch ($form_selected) {
    case "form_psychosocial":
         ...
         $extra_fields = ", fr.servicecode, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.clinical_intervention, fr.response_to_intervention, fr.credentials, fr.sig_date, fr.provider_id, fr.provider_print_name, fr.timestart, fr.timeend, fr.created";
    break;
    case "form_soap_pirc":
         $form_name = "SOAP Notes";
         $extra_fields = ", fr.servicecode, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.objective, fr.subjective, fr.assessment, fr.plan, fr.created, provider_credentials, provider_signature_date, fr.provider_print_name, fr.timestart, fr.timeend";
    break;
    case "form_med_management":
         $form_name = "Medication Management";
         $extra_fields = ", fr.servicecode, units, fr.complaint, fr.created";
    break;
     case "form_assessment_cmh":
         $form_name = "In-Depth Assessment";
         $extra_fields = ", fr.servicecode, units, provider_credentials, provider_signature_date, fr.provider_print_name, fr.created";
    break;
    case "form_treatment_plan":
    $form_selected = "form_treatment_plan";
         $form_name = "Treatment Plan";
         $extra_fields = ", fr.service_code, unit, provider_credentials, provider_signature_date, fr.provider_print_name, fr.date_created ";
    break;
    ...
    $form_selected = "form_psychiatric_evaluation";
         ...
         $extra_fields = ", fr.servicecode, units, physician_credentials AS provider_credentials, physician_signature_date AS provider_signature_date, physician_print_name AS provider_print_name, fr.created";
    break;
    ...
    $form_selected = "form_cfars";
         $form_name = "FARS";
         $extra_fields = ", fr.servicecode, units, fr.provider_print_name, fr.created";
    break;
    case "form_cfars":
    $form_selected = "form_cfars";
         $form_name = "CFARS";
    ...
    $form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.service_code, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.created, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end, fr.subjective, fr.objective, fr.assessment, fr.plan";
    break;
	case "form_progress_note_psr":
	$form_selected = "form_progress_note";
         $form_name = "Progress Note - PSR";
         $extra_fields = ", fr.service_code, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.created, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end,fr.deficit_problems_behavior_addressed, fr.interventions, fr.response_to_intervention";
    break;
	...
	$form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.service_code, units, fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.created, provider_credentials, provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end";
    break;
