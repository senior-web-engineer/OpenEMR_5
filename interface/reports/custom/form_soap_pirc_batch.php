...
$connection = @mysql_connect("localhost", "openemr", "4050!Pirc") or die(mysql_error());
$db = @mysql_select_db($db_name, $connection) or die(mysql_error());

$sql = "SELECT ". 
	"fr.id, fr.pid, fr.subjective, fr.objective, fr.assessment, fr.txgoals".
	", fr.plan, fr.provider_print_name, fr.credentials, fr.sig_date, fr.provider, fr.timestart, fr.timeend ".
