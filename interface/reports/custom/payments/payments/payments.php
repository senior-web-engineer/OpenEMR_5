...
<INPUT TYPE=DATE class="datepicker" data-date-format="yyyy/mm/dd" SIZE=117 NAME=start_date  style="width: 135px">&nbsp;&nbsp; Enter DOS End Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<INPUT TYPE=DATE class="datepicker" data-date-format="yyyy/mm/dd" SIZE=117 NAME=end_date  style="width: 135px"> <br>
