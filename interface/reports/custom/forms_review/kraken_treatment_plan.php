...
echo "form Selected:". $form_selected;
...
//
							    ...
							    //$comments_to_post = ":".$_SESSION["authUser"]." ".$_POST["comments_log"][$i]." ";
...
//													    }
								sqlInsert("update $form_selected set status = '".$_POST["status"][$i]."', supervisor_signature = '".$_POST["electronic_signature"]."',provider_print_name = '".$_POST["provider_print_name"][$i]."', comments_log = CONCAT('".$_POST["comments_log_view"][$i]."', NOW(), ' ','".$_SESSION["authUser"]."',' :', '".$_POST["comments_log"][$i]."','\n' ) where id = $form_id");

								//sqlInsert("update $form_selected set status = '".$_POST["status"][$i]."', comments_log = CONCAT(comments_log, NOW(), ' ','".$_SESSION["authUser"]."',' :' '".$_POST["comments_log"][$i]."','\n' ) where id = $form_id");
								//sqlInsert("update $form_selected set status = '".$_POST["status"][$i]."', comments_log = '".$_POST["comments_log"][$i]."' where id = $form_id");
