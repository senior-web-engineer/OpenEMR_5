...
switch ($form_selected) {
	...
	$form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.deficit_problems_behavior_addressed, fr.interventions, fr.response_to_intervention, fr.provider_credentials, fr.provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end";
    break;
	...
	$form_selected = "form_progress_note";
         ...
         $extra_fields = ", fr.diagnosis1, fr.diagnosis2, fr.diagnosis3, fr.diagnosis4, fr.provider_credentials, fr.provider_signature_date, fr.provider_print_name, fr.time_start, fr.time_end";
    break;
