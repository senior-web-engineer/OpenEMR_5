...
function ActionDeterminator() {
  if(document.myform.form_selected[0].selected == true) {
    document.myform.action = 'forms_results.php';
  }
  ...
  if(document.myform.form_selected[4].selected == true) {
    document.myform.action = 'forms_results_progress_note.php';
    }
  ...
  if(document.myform.form_selected[10].selected == true) {
    document.myform.action = 'forms_results_treatment_plan.php';
...
<div class="form-group col-sm-12">
	...
	<select name="form_status" class="form-control" required>
	        <option value="">-----</option>
