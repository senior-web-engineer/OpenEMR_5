...
$count = $row['COUNT(pd.pid)'];
	...
	echo "<tr><td class='style1'> " .$lname."</td><td class='style1'> " . $fname."</td><td class='style1'> "  . $active.
		"</td><td class='style1'> " .
		$count."</td><td class='style1'> ".
