...
echo "HI", $result['fname'],  $result['lname'], $result['mname'], $result['DOB'], "<br>";
...
$headers = array();
$headers[] = "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjbGllbnRfaWQiOiJkRFRzSFpxYnJ5MW1EU2xtUXpwWiIsInNjb3BlIjowLCJqdGkiOiIzMjQ2MmJkNjYzODk0MTgxODYzMjE4NDI3NjUzM2E5ZiIsImV4cCI6MTUzMDc0NDg3OH0.nXapUHVOOElfT4jyB4B16Rz9Qda6tj8rAITkJwU8ENk"; 
