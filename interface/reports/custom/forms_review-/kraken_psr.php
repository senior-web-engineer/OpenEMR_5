...
<table class="selection table" id="selection">
	...
	<div>
		...
		<select class="form-control input-sm" id="status" name="status[]" style="width: 199px" required>
			...
			<option>Ready for Billing</option>Ready for Billing
			<option value="Error Report/Correction(s) Needed">Error Report/Correction(s) Needed</option>
			<option>Void/Delete Request</option>Void/Delete Request
		</select>
		</td>
		<td>
		Log:
		...
		New Entry:
		<textarea class="form-control input-sm" wrap=virtual name="comments_log[]" id="comments_log"style="height: 132px; width: 548px;" required ></textarea>
		</td>
