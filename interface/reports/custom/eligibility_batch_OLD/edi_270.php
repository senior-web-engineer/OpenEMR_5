...
//			<table>
	echo "<div id='report_results'>".		
	     "<div class='table-responsive'>".
				...
				<thead>
					<th style='width:5%;'>	". htmlspecialchars( xl('Select'), ENT_NOQUOTES) ."</th>
					...
					<th style='width:8%;'>	". htmlspecialchars( xl('Trading Partner ID'), ENT_NOQUOTES) ."</th>
					<th style='width:5%;' >	". htmlspecialchars( xl('Patient ID'), ENT_NOQUOTES) ."</th>
					<th style='width:5%;' >	". htmlspecialchars( xl('Date Last Checked'), ENT_NOQUOTES) ."</th>
					<th style='width:5%;' >	". htmlspecialchars( xl('Days Elapsed'), ENT_NOQUOTES) ."</th>

					<th style='width:5%;' >	". htmlspecialchars( xl('Last Status'), ENT_NOQUOTES) ."</th>
					...
					<th style='width:8%;'>	". htmlspecialchars( xl('Patient Mname'), ENT_NOQUOTES) ."</th>
...
//echo "<input type='checkbox' id='checkAll'> <label for='checkAll'>Check All</label>";
	while ($row = sqlFetchArray($res)) {
		...
		$policystatus = $row['active'];
		
		
		echo "	<tr id='PR".$i."_". htmlspecialchars( $row['policy_number'], ENT_QUOTES)."'>";
		if ($datediff <= '0' || $row['trading_partner_id'] =='' && $policystatus =='' ){ 
				echo "<td><input type='checkbox' class='boxes' id ='boxes' name='boxes' style='width:60%;' disabled></td>";	
							}else{
				echo "	<td><input type='checkbox' class='boxes' id ='boxes' name='boxes' checked style='width:60%;'></td>";					
							}
		echo "	<td class ='detail' style='width:5%;'><input class='form-control input-sm' type='text' name='facility_name[]' value=". htmlspecialchars( $row['facility_name'], ENT_NOQUOTES) ." ></td>";
		...
		echo "  <td class ='detail' style='width:8%;'><input class='form-control input-sm' type='text' name='facility_npi[]' value='1396801999' ></td>
				<td class ='detail' style='width:15%;'>". htmlspecialchars( $row['payer_name'], ENT_NOQUOTES) ."</td>
				<td class ='detail' style='width:8%;'><input class='form-control input-sm' type='text' name='api_code[]' value='".  htmlspecialchars( $row['trading_partner_id'], ENT_NOQUOTES) ."' ></td>
				<td class ='detail' style='width:5%;'><input class='form-control input-sm' type='text' name='pid[]' value=".  htmlspecialchars( $row['pid'], ENT_NOQUOTES) ." ></td>
		...
		echo "	<td class ='detail' style='width:8%;'><input class='form-control input-sm' type='text' name='policy_number[]' value=".  htmlspecialchars( $row['policy_number'], ENT_NOQUOTES) ." ></td>
				<td class ='detail' style='width:8%;'><input class='form-control input-sm' type='text' name='fname[]' value=". htmlspecialchars( $row['subscriber_fname'], ENT_NOQUOTES) ." ></td>";
		echo "	<td class ='detail' style='width:8%;'><input class='form-control input-sm' type='text' name='mname[]' value='". htmlspecialchars( $row['subscriber_mname'])."'></td>" ;
		echo "	<td class ='detail' style='width:8%;'><input class='form-control input-sm' type='text' name='lname[]' value=". htmlspecialchars( $row['subscriber_lname'], ENT_NOQUOTES) ." ></td>
				<td class ='detail' style='width:7%;'><input class='form-control input-sm' type='text' name='dob[]' value=". htmlspecialchars( $row['subscriber_dob'], ENT_NOQUOTES) ." ></td>
...
//<form method='post' name='theform' id='theform' action='batch_check_mock.php' onsubmit="return top.restoreSession()">
    ...
    <body class="body_top">
        ...
        <span class='title'><?php echo xlt('Report'); ?> - <?php echo xlt('Eligibility Inquiry'); ?></span>
